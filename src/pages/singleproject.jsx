...
function single_project() {
  ...
  return (
  <Layout>
     <h1 className="project_title" style={{}}>{name}</h1>
     <hr style={{ marginBottom: '50px' }} />
    <div className="single_project">
    <div id="project-content">
      <div id="project-description">{description}</div>
      <p id="project-link"><a href={link}>{link}</a></p>
      <p id="project-github"><a href={github}>Github</a></p>
      <p id="project-github"><a href={github}>View Project</a></p>
    </div>
